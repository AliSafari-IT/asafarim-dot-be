  ...
  return (
    <div className="print-layout-container">
      ...
      <header className="print-header">
        <h1 className="print-name">{resume.contact?.fullName || resume.title}</h1>
        ...
        <div className="print-right">
            ...
            <section className="print-section">
              ...
              <div className="print-skills">
                {resume.skills.map((skill) => (
                  <div key={skill.id} className="print-skill">
          ...
          {resume.languages && resume.languages.length > 0 && (
            <section className="print-section">
              ...
              {resume.languages.map((lang) => (
                <div key={lang.id} className="print-lang">
                  <span>{lang.name}</span>
          ...
          {resume.certificates && resume.certificates.length > 0 && (
            <section className="print-section">
              ...
              {resume.certificates.slice(0, 4).map((cert) => (
                <div key={cert.id} className="print-cert">
