  ...
  return (
    <section className="section">
      <div className="container">
        <h1 className="mb-4 text-2xl font-bold text-phosphor">About ASafariM</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-lg mb-8">
          <div className="p-4 bg-background shadow-sm rounded-lg">
            <h2 className="text-primary mb-2 text-lg font-semibold">Our Mission</h2>
            <p>
          ...
          <div className="p-4 bg-background shadow-sm rounded-lg">
            <h2 className="text-primary mb-2 text-lg font-semibold">Technologies</h2>
            <p>
