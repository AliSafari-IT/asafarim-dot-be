        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageMastery = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChildCourseEnrollments", x => x.EnrollmentId);
                    table.ForeignKey(
                        name: "FK_ChildCourseEnrollments_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChildCourseEnrollments_Users_ChildUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreezeAvailable = table.Column<bool>(type: "boolean", nullable: false),
                    LastFreezeUsed = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonId = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<string>(type: "text", nullable: false),
                    MasteryLevel = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    ...
                    TotalTimeSpentMinutes = table.Column<int>(type: "integer", nullable: false),
                    TotalPracticeAttempts = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonProgress_Users_ChildUserId",
                        column: x => x.ChildUserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PracticeItemId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LessonId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    TimeEstimateSeconds = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PracticeItems", x => x.PracticeItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PracticeAttempts", x => x.AttemptId);
                    table.ForeignKey(
                        name: "FK_PracticeAttempts_PracticeItems_PracticeItemId",
                        column: x => x.PracticeItemId,
                        principalTable: "PracticeItems",
                        principalColumn: "PracticeItemId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PracticeAttempts_Users_ChildUserId",
                        column: x => x.ChildUserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChildCourseEnrollments_ChildUserId_CourseId",
                table: "ChildCourseEnrollments",
                columns: new[] { "ChildUserId", "CourseId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChildCourseEnrollments_CourseId",
                table: "ChildCourseEnrollments",
                column: "CourseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonProgress_ChildUserId_LessonId",
                table: "LessonProgress",
                columns: new[] { "ChildUserId", "LessonId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonProgress_NextReviewDate",
                table: "LessonProgress",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PracticeAttempts_ChildUserId",
                table: "PracticeAttempts",
                column: "ChildUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PracticeAttempts_PracticeItemId",
                table: "PracticeAttempts",
