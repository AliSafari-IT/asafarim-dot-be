...
public class AppDbContextDesignTimeFactory : IDesignTimeDbContextFactory<AppDbContext>
{
    ...
    {
        var connectionString = ResolveConnectionString(
            "CONNECTIONSTRINGS__JOBSCONNECTION",
            "ConnectionStrings__JobsConnection"
        );
    ...
    private static string ResolveConnectionString(params string[] environmentVariableNames)
    {
        ...
        throw new InvalidOperationException(
            "Database connection string not found. Set CONNECTIONSTRINGS__JOBSCONNECTION (or ConnectionStrings__JobsConnection) in your environment, or ensure /etc/asafarim/env contains it."
        );
    }
}
