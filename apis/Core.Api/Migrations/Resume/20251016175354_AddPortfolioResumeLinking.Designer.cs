...
namespace Core.Api.Migrations.Resume
{
    ...
    [Migration("20251016175354_AddPortfolioResumeLinking")]
    partial class AddPortfolioResumeLinking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Api.Models.Resume.ActivityLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Core.Api.Models.Resume.ProjectResumeLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProjectId", "ResumeId")
                        .IsUnique();

                    b.ToTable("ProjectResumeLinks", "public");
                });
            ...
            modelBuilder.Entity("Core.Api.Models.Resume.PublicationResumeLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PublicationId", "ResumeId")
                        .IsUnique();

                    b.ToTable("PublicationResumeLinks", "public");
                });
            ...
            modelBuilder.Entity("Core.Api.Models.Resume.PublicationResumeLink", b =>
                {
                    b.HasOne("Core.Api.Models.Publication", "Publication")
                        .WithMany("PublicationResumeLinks")
                        .HasForeignKey("PublicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Api.Models.Publication", b =>
                {
                    ...
                    b.Navigation("PublicationResumeLinks");
                });
            ...
            modelBuilder.Entity("Core.Api.Models.Resume.Project", b =>
                {
                    ...
                    b.Navigation("ProjectResumeLinks");
