...
function Website({ width = 16, height = 16, viewBox = "0 0 16 16", fill = "currentColor", stroke = "none", strokeWidth = 0, strokeLinecap = "round", title, onClick, className, style }: SvgIconProps) {
    return (
